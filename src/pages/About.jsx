        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  ...
                  a comprehensive academic support system, offering specialized
                  tutoring in Mathematics, Physical Sciences, Life Sciences, and
                  Accounting. Our approach combines expert knowledge with
                  genuine care for each student's success.
                </p>
                <p>
                  We understand that academic struggles can affect confidence
                  and motivation. That's why we don't just teach subjects – we
                  build relationships, foster understanding, and create an
                  environment where students feel safe to ask questions and make
                  mistakes.
                </p>
              </div>
            </div>
            <div className="relative">
              <img
                src="Screenshot 2026-02-04 at 21.43.48 (2).png"
              ...
              {[
                {
                  ...
                  title: "Excellence",
                  description:
                    "We strive for excellence in everything we do, from teaching methods to student outcomes.",
                },
                {
                  icon: Heart,
                  title: "Compassion",
                  description:
                    "We understand that every student is unique and approach each with empathy and patience.",
                },
                {
                  icon: CheckCircle,
                  title: "Integrity",
                  description:
                    "We maintain the highest standards of honesty, reliability, and professionalism.",
                },
                {
                  icon: Users,
                  title: "Community",
                  description:
                    "We build a supportive learning community where students and tutors grow together.",
                },
              ].map((value, index) => (
                <Card
                  key={index}
                  className="text-center border-2 hover:border-[#1ac8db] transition-all"
                >
            ...
            <Card className="bg-[#2c3e73] text-white">
              <CardContent className="p-8">
                ...
                <p className="text-white/90 leading-relaxed">
                  ...
                  personal, engaging, and effective.
                </p>
              </CardContent>
            </Card>
            ...
            {[
              {
                ...
                title: "Assessment",
                description:
                  "We begin by understanding your current level, learning style, and academic goals through comprehensive assessment.",
              },
              {
                step: "02",
                title: "Personalization",
                description:
                  "Based on the assessment, we create a customized learning plan that addresses your specific needs and challenges.",
              },
              {
                step: "03",
                title: "Implementation",
                description:
                  "Our expert tutors work with you using proven teaching methods, regular feedback, and continuous progress monitoring.",
              },
            ].map((step, index) => (

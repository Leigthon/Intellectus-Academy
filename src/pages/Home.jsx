              ...
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-[3rem] p-10 shadow-2xl border border-gray-100">
                  <img
                    ...
                    className="w-full h-auto rounded-full mb-8"
                  />
                  <div className="grid grid-cols-2 gap-4">
                    {subjects.map((subject) => (
                      ...
                      >
                        <p className="text-sm font-bold text-[#2c3e73]">
                          {subject.name}
                        </p>
                      </div>
                    ))}
            ...
            {[
              {
                ...
                description:
                  "Every student learns differently. We tailor our approach to match your unique learning style.",
                icon: Users,
              },
              {
                title: "Experienced Tutors",
                description:
                  "Our tutors are qualified professionals with proven track records of student success.",
                icon: Award,
              },
              {
              ...
              },
              {
                ...
                description:
                  "From homework help to exam prep, we cover all your academic needs.",
                icon: CheckCircle,
              },
            ].map((feature, index) => (
              <Card
              ...
              >
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-[#2c3e73] mb-3">
                    {feature.title}
                  </h3>
